...
export function DarkClassicRidePage(props: TemplateProps) {
  ...
  return (
    <Shell {...props}>
      <section className="mx-auto max-w-6xl px-6 pb-12 pt-4">
        ...
        <p className="mt-6 max-w-2xl text-lg text-neutral-400">{sub}</p>
      </section>
...
export function DarkClassicDrivePage(props: TemplateProps) {
  const { site, locale } = props;
  const c = site.content;
